<nav x-data="{ open: false }" class="bg-[#18191a] border-b border-gray-800">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('tasks.create')" :active="request()->routeIs('tasks.create')" class="text-white hover:text-gray-300">
                        {{ __('Create Task') }}
                    </x-nav-link>
                    <x-nav-link :href="route('tasks.completed')" :active="request()->routeIs('tasks.completed')" class="text-white hover:text-gray-300">
                        {{ __('Completed Tasks') }}
                    </x-nav-link>
                </div>
            </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('tasks.index')" :active="request()->routeIs('tasks.index')" class="text-white hover:bg-gray-700">
                {{ __('All Tasks') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('tasks.create')" :active="request()->routeIs('tasks.create')" class="text-white hover:bg-gray-700">
                {{ __('Create Task') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('tasks.completed')" :active="request()->routeIs('tasks.completed')" class="text-white hover:bg-gray-700">
                {{ __('Completed Tasks') }}
            </x-responsive-nav-link>
        </div>
